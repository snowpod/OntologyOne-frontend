    ...
    <div>
      ...
      >
        ...
        <button
          ...
          className="chat-clear-button absolute right-2 bottom-2 text-white bg-indigo-600 hover:bg-indigo-400 w-7 h-7 rounded-full flex items-center justify-center transition-all duration-200 text-sm"
        >
          🗙
        </button>
        )}
