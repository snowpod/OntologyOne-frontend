            ...
            <div className={styles.inputWrapper}>
              <div className={styles.inputContainer}>
                ...
                <textarea
                  ...
                  placeholder={
                    feedbackMode ? feedbackInput_placeholder : chatInput_placeholder
                  }
                  className={`w-full p-2 border border-gray-400 rounded-lg focus:outline-none resize-none pr-8 ${
                ...
                <button
                  ...
                  className="chat-clear-button absolute right-2 bottom-8 text-white bg-indigo-600 hover:bg-indigo-400 w-7 h-7 rounded-full flex items-center justify-center transition-all duration-200 text-sm"
                >
                  🗙
                </button>
                )}
